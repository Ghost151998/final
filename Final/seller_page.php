    ...
    <div class="modal-dialog" style="margin: 10vh auto 0px auto;width: 60%;margin-bottom: 5%;">
      ...
      <div class="modal-content" style="opacity: 0.9;">
        <div class="modal-header" style="padding:35px 50px;">
          <h2><span class="glyphicon glyphicon-euro"></span> Seller Form</h2>
        </div>
        <div class="modal-body" style="padding:40px 50px; margin-bottom: 30px;">
          ...
          <div class="category_select col-sm-12" style="margin-bottom: 10%;">
            ...
            <div class="form-group" >
              ...
              <input type="text" name="book_author" class="form-control required author" id="book_author"  data-placement="right" data-trigger="manual" data-content="enter valid 8 digit registration number starting with 20">
            </div>

            <div class="form-group" >
              <label for="book_title">Title</label>
              <input type="text" name="book_title" class="form-control required title" id="book_title"  data-placement="right" data-trigger="manual" data-content="max 30char">
            </div>


            <div class="form-group">
              <label for="book_edition">Edition</label>
              <input type="text" name="book_edition" class="form-control required edition" id="book_edition"  data-placement="right" data-trigger="manual" data-content="first name without space upto 30char max">
            </div>


            <div class="form-group" >
              <label for="book_branch">Branch</label>
             <select name="book_branch" id="branch" class="form-control required" >
            ...
            <div class="form-group" id="sem">
              ...
              <select name="book_sem" class="form-control required">
           ...
           <div id="bike">
            ...
            <div class="form-group" >
              ...
              <input type="text" name="bike_brand" class="form-control required brand" id="bike_brand"  data-placement="right" data-trigger="manual" data-content="max 20char">
            </div>
            ...
            <div class="form-group">
              ...
              <label class="radio_label">Non-Gear
                  <input type="radio"  name="category" id="non-gear" class="radio_btn required" value="0" checked="checked">
                  <span class="radio_check"></span>
              </label>

              <label class="radio_label">Gear
                  <input type="radio" name="category" id="gear" class="radio_btn required" value="1" >
                  <span class="radio_check"></span>
              </label>
            ...
            <div class="form-group" >
              ...
              <input type="text" name="bike_colour" class="form-control required color" id="bike_color"  data-placement="right" data-trigger="manual" data-content="enter valid address">
            </div>
          ...
          <div id="misc">
            ...
            <div class="misc_item_name">
              ...
              <input type="text" name="misc_name" class="form-control required item_name" id="misc_item_name"  data-placement="right" data-trigger="manual" data-content="must be atleast 6 characters and max 20">
            </div>
