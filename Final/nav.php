...
<nav class="navbar  navbar-inverse" data-spy="affix" >
    <div class="container-fluid ">
      ...
      <ul class="nav navbar-nav navbar-right">       
          ...
          <li><a>Welcome,</a></li>
         <li class="dropdown">
            <a href="#" class="dropdown-toggle js-activated"><?php echo $_SESSION["user_name"]; ?><b class="caret"></b></a>
            <ul class="dropdown-menu" style="background-color: black;opacity: 0.9;border: solid 1px;" >
               <li><a  class="c"   href='logout.php' style="color: white;">Logout</a></li>
            </ul></li>

        <li><a href='cart.php'><span class="glyphicon glyphicon-shopping-cart"></span>Cart<span class="pull-right col-sm-1"><?php echo $_SESSION["cart_count"]; ?></span></a></li>
      </ul>
